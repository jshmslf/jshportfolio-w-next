...
function AlertDialogHeader({
  ...
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 text-center sm:text-left text-neutral-300", className)}
      {...props}
    />
  )
}
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      className={cn(buttonVariants({ variant: "outline" }), "text-neutral-500", className)}
      {...props}
    />
  )
}
